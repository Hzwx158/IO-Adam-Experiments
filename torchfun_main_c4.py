...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = AdamW_Decomposed(trainable_params, lr=args.lr, betas=(0.9, args.beta2),weight_decay=args.weight_decay, p=2, max_queue_length=args.rank, w_momentum=True)
